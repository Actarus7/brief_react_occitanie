...
export default function EventLong({ data }) {
    ...
    return (<><div className="d-flex border border-danger border-2 rounded-5 flex-wrap mt-5 flex-column mb-4 ">
        <div>
        ...
        <div className="d-flex border border-danger border-2 rounded-5 p-3 m-3">
            <p> {data.descriptif_long}</p>
        </div>
        <div className="d-flex border border-danger border-2 rounded-5 flex-column p-3 me-5 large ms-5 mb-3">
        ...
        <div className="d-flex border border-danger border-2 rounded-5 flex-column p-3 me-5 large ms-5 mb-4">
